...
for item in viet_to_english:
    ...
    try:
        ...
        driver.find_element_by_xpath("/html/body/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[2]/div/div/div[1]/textarea")\
                .send_keys(send_item)
        sleep(3)
        basic_translation = driver.find_element_by_xpath('/html/body/div[2]/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/div[3]/div[1]/div[2]/div/span[1]/span').text
        print(item)
        try:
...
## remove 'frequency' bar and newline character from translation
        ...
        extra_shortcut = shortcut + '?' + language[0]
        shortcut = shortcut + '.' + language[0]
